...
public class InspectionReceiptService {
    ...
    /**
     * 検収明細書ファイルの存在チェックを行い、GoogleDriveアップロード用フォルダへ移動する
     *
     */
    public void getInspectionReceiptFiles() {
    	String moveToPath = CommonConsts.OUTPUT_INSPECTION_RECEIPT_DIR;
    	FileApi.createDirectories(moveToPath);
    	// マウント済である前提
    	String baseFolderPath = CommonConsts.INPUT_INSPECTION_RECEIPT_DIR;
