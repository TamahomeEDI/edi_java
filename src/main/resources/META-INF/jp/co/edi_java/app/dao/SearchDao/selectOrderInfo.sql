...
FROM
	...
	SELECT
		*,
	    ...
	    WHEN INF.WORK_NUMBER IS NOT NULL AND INF.STAFF_RECEIPT_FLG = '0' THEN '3'
	    WHEN INF.STAFF_RECEIPT_FLG = '1' AND INF.REMAND_FLG = '0' THEN '4'
	    ELSE '0'
		END ORDER_STATUS
	FROM
		(
...
/*%end*/
/*%if params.orderStatus != null && params.orderStatus != "" && params.orderStatus != "0"*/
AND ORDER_STATUS = /*params.orderStatus*/0
/*%end*/
;